...
Later modules (integrated paper7, then Energy and Guarantee in bounded downstream roles) instantiate this extensibility at policy-pattern level under matched fixed paired protocols.
