...
1. **Paper 1** (this repository): Saito, K. (2025). NRR-Core: Non-Resolution Reasoning as a Computational Framework for Contextual Identity and Ambiguity Preservation. *arXiv:2512.13478*
2. **Paper 2**: Saito, K. (2026). Text-to-State Mapping for Non-Resolution Reasoning: The Contradiction-Preservation Principle. → [nrr-phi-mapping](https://github.com/kei-saito-research/nrr-phi-mapping) *(arXiv:2601.19933)*
